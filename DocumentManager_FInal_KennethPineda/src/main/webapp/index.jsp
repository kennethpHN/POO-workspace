					...
					<div class="info-card card">
						...
						<div class="card-body mx-3">
							...
							<div class="col m-2">
								<div class="col">
									<div class="row">
										<div class="doc-info col border-0 rounded-3 mb-2 py-2" id="typeOneCounter">0 Documentos
											de tipo Revista</div>
									</div>
									<div class="row">
										<div class="doc-info2 col border-0 rounded-3 py-2 mb-2"id="typeTwoCounter">0 Documentos
											de tipo Libro</div>
									</div>
									<div class="row">
										<div class="doc-info col border-0 rounded-3 py-2 mb-2"id="typeThreeCounter">0 Documentos
											de tipo Texto</div>
									</div>
									<div class="row">
										<div class="doc-info2 col border-0 rounded-3 py-2 mb-2"id="typeFourCounter">0 Documentos
											de tipo Imagen</div>
									</div>
								</div>
